...
static const _SetSimulateTick_Request_type_support_symbol_names_t _SetSimulateTick_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, SetSimulateTick_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_bt_py_interfaces, srv, SetSimulateTick_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_bt_py_interfaces, srv, SetSimulateTick_Request)() {
  return &::ros_bt_py_interfaces::srv::rosidl_typesupport_c::SetSimulateTick_Request_message_type_support_handle;
}
...
static const _SetSimulateTick_Response_type_support_symbol_names_t _SetSimulateTick_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, SetSimulateTick_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_bt_py_interfaces, srv, SetSimulateTick_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_bt_py_interfaces, srv, SetSimulateTick_Response)() {
  return &::ros_bt_py_interfaces::srv::rosidl_typesupport_c::SetSimulateTick_Response_message_type_support_handle;
}
...
static const _SetSimulateTick_type_support_symbol_names_t _SetSimulateTick_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, SetSimulateTick)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_bt_py_interfaces, srv, SetSimulateTick)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros_bt_py_interfaces, srv, SetSimulateTick)() {
  return &::ros_bt_py_interfaces::srv::rosidl_typesupport_c::SetSimulateTick_service_type_support_handle;
}
