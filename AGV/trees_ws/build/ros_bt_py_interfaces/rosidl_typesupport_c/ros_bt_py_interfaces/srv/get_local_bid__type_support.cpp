...
static const _GetLocalBid_Request_type_support_symbol_names_t _GetLocalBid_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, GetLocalBid_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_bt_py_interfaces, srv, GetLocalBid_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_bt_py_interfaces, srv, GetLocalBid_Request)() {
  return &::ros_bt_py_interfaces::srv::rosidl_typesupport_c::GetLocalBid_Request_message_type_support_handle;
}
...
static const _GetLocalBid_Response_type_support_symbol_names_t _GetLocalBid_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, GetLocalBid_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_bt_py_interfaces, srv, GetLocalBid_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_bt_py_interfaces, srv, GetLocalBid_Response)() {
  return &::ros_bt_py_interfaces::srv::rosidl_typesupport_c::GetLocalBid_Response_message_type_support_handle;
}
...
static const _GetLocalBid_type_support_symbol_names_t _GetLocalBid_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, GetLocalBid)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_bt_py_interfaces, srv, GetLocalBid)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros_bt_py_interfaces, srv, GetLocalBid)() {
  return &::ros_bt_py_interfaces::srv::rosidl_typesupport_c::GetLocalBid_service_type_support_handle;
}
