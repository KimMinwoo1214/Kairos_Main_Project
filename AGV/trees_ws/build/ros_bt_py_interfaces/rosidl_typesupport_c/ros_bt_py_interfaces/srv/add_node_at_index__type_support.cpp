...
static const _AddNodeAtIndex_Request_type_support_symbol_names_t _AddNodeAtIndex_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, AddNodeAtIndex_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_bt_py_interfaces, srv, AddNodeAtIndex_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_bt_py_interfaces, srv, AddNodeAtIndex_Request)() {
  return &::ros_bt_py_interfaces::srv::rosidl_typesupport_c::AddNodeAtIndex_Request_message_type_support_handle;
}
...
static const _AddNodeAtIndex_Response_type_support_symbol_names_t _AddNodeAtIndex_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, AddNodeAtIndex_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_bt_py_interfaces, srv, AddNodeAtIndex_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_bt_py_interfaces, srv, AddNodeAtIndex_Response)() {
  return &::ros_bt_py_interfaces::srv::rosidl_typesupport_c::AddNodeAtIndex_Response_message_type_support_handle;
}
...
static const _AddNodeAtIndex_type_support_symbol_names_t _AddNodeAtIndex_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, AddNodeAtIndex)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_bt_py_interfaces, srv, AddNodeAtIndex)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros_bt_py_interfaces, srv, AddNodeAtIndex)() {
  return &::ros_bt_py_interfaces::srv::rosidl_typesupport_c::AddNodeAtIndex_service_type_support_handle;
}
