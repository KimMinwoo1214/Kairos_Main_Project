...
#include "ros_bt_py_interfaces/srv/detail/add_node_at_index__rosidl_typesupport_fastrtps_c.h"
...
using _AddNodeAtIndex_Request__ros_msg_type = ros_bt_py_interfaces__srv__AddNodeAtIndex_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AddNodeAtIndex_Request__ros_msg_type * ros_message = static_cast<const _AddNodeAtIndex_Request__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _AddNodeAtIndex_Request__ros_msg_type * ros_message = static_cast<_AddNodeAtIndex_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: parent_name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _AddNodeAtIndex_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_bt_py_interfaces__srv__AddNodeAtIndex_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_bt_py_interfaces__srv__AddNodeAtIndex_Request;
    is_plain =
      (
...
static size_t _AddNodeAtIndex_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_bt_py_interfaces__srv__AddNodeAtIndex_Request(
...
static message_type_support_callbacks_t __callbacks_AddNodeAtIndex_Request = {
...
static rosidl_message_type_support_t _AddNodeAtIndex_Request__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AddNodeAtIndex_Request,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, AddNodeAtIndex_Request)() {
  return &_AddNodeAtIndex_Request__type_support;
}
...
using _AddNodeAtIndex_Response__ros_msg_type = ros_bt_py_interfaces__srv__AddNodeAtIndex_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AddNodeAtIndex_Response__ros_msg_type * ros_message = static_cast<const _AddNodeAtIndex_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AddNodeAtIndex_Response__ros_msg_type * ros_message = static_cast<_AddNodeAtIndex_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
static uint32_t _AddNodeAtIndex_Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_bt_py_interfaces__srv__AddNodeAtIndex_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_bt_py_interfaces__srv__AddNodeAtIndex_Response;
    is_plain =
      (
...
static size_t _AddNodeAtIndex_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_bt_py_interfaces__srv__AddNodeAtIndex_Response(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_AddNodeAtIndex_Response = {
  "ros_bt_py_interfaces::srv",
...
static rosidl_message_type_support_t _AddNodeAtIndex_Response__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AddNodeAtIndex_Response,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, AddNodeAtIndex_Response)() {
  return &_AddNodeAtIndex_Response__type_support;
}
...
// already included above
// #include "ros_bt_py_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ros_bt_py_interfaces/srv/add_node_at_index.h"
...
static service_type_support_callbacks_t AddNodeAtIndex__callbacks = {
  "ros_bt_py_interfaces::srv",
  "AddNodeAtIndex",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, AddNodeAtIndex_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, srv, AddNodeAtIndex_Response)(),
...
static rosidl_service_type_support_t AddNodeAtIndex__handle = {
  rosidl_typesupport_fastrtps_c__identifier,
  &AddNodeAtIndex__callbacks,
