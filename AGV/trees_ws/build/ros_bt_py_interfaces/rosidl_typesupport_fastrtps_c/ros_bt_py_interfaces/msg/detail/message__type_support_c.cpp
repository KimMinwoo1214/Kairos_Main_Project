...
#include "ros_bt_py_interfaces/msg/detail/message__rosidl_typesupport_fastrtps_c.h"
...
using _Message__ros_msg_type = ros_bt_py_interfaces__msg__Message;
...
static uint32_t _Message__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_bt_py_interfaces__msg__Message(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_bt_py_interfaces__msg__Message;
    is_plain =
      (
...
static size_t _Message__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_bt_py_interfaces__msg__Message(
