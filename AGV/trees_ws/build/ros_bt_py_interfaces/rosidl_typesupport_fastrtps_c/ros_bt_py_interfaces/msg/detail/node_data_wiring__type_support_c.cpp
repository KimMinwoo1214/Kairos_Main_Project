...
#include "ros_bt_py_interfaces/msg/detail/node_data_wiring__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_bt_py_interfaces/msg/detail/node_data_location__functions.h"  // source, target
...
using _NodeDataWiring__ros_msg_type = ros_bt_py_interfaces__msg__NodeDataWiring;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _NodeDataWiring__ros_msg_type * ros_message = static_cast<const _NodeDataWiring__ros_msg_type *>(untyped_ros_message);
  // Field name: source
  {
  ...
  void * untyped_ros_message)
{
  ...
  _NodeDataWiring__ros_msg_type * ros_message = static_cast<_NodeDataWiring__ros_msg_type *>(untyped_ros_message);
  // Field name: source
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _NodeDataWiring__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_bt_py_interfaces__msg__NodeDataWiring(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_bt_py_interfaces__msg__NodeDataWiring;
    is_plain =
      (
...
static size_t _NodeDataWiring__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_bt_py_interfaces__msg__NodeDataWiring(
...
static message_type_support_callbacks_t __callbacks_NodeDataWiring = {
...
static rosidl_message_type_support_t _NodeDataWiring__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NodeDataWiring,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, msg, NodeDataWiring)() {
  return &_NodeDataWiring__type_support;
}
