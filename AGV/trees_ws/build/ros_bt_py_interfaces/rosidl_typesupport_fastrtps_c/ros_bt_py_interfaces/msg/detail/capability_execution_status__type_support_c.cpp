...
#include "ros_bt_py_interfaces/msg/detail/capability_execution_status__rosidl_typesupport_fastrtps_c.h"
...
using _CapabilityExecutionStatus__ros_msg_type = ros_bt_py_interfaces__msg__CapabilityExecutionStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CapabilityExecutionStatus__ros_msg_type * ros_message = static_cast<const _CapabilityExecutionStatus__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _CapabilityExecutionStatus__ros_msg_type * ros_message = static_cast<_CapabilityExecutionStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: interface
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _CapabilityExecutionStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_bt_py_interfaces__msg__CapabilityExecutionStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_bt_py_interfaces__msg__CapabilityExecutionStatus;
    is_plain =
      (
...
static size_t _CapabilityExecutionStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_bt_py_interfaces__msg__CapabilityExecutionStatus(
...
static message_type_support_callbacks_t __callbacks_CapabilityExecutionStatus = {
...
static rosidl_message_type_support_t _CapabilityExecutionStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CapabilityExecutionStatus,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, msg, CapabilityExecutionStatus)() {
  return &_CapabilityExecutionStatus__type_support;
}
