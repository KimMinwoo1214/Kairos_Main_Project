...
#include "ros_bt_py_interfaces/msg/detail/documented_node__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // child_names, doc, module, name, node_class, state, tags, version
#include "rosidl_runtime_c/string_functions.h"  // child_names, doc, module, name, node_class, state, tags, version
...
using _DocumentedNode__ros_msg_type = ros_bt_py_interfaces__msg__DocumentedNode;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DocumentedNode__ros_msg_type * ros_message = static_cast<const _DocumentedNode__ros_msg_type *>(untyped_ros_message);
  // Field name: module
  {
  ...
  // Field name: doc
  {
    const rosidl_runtime_c__String * str = &ros_message->doc;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  _DocumentedNode__ros_msg_type * ros_message = static_cast<_DocumentedNode__ros_msg_type *>(untyped_ros_message);
  // Field name: module
  {
    std::string tmp;
    cdr >> tmp;
  ...
  // Field name: doc
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->doc.data) {
      rosidl_runtime_c__String__init(&ros_message->doc);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->doc,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'doc'\n");
      return false;
    }
  }
...
static uint32_t _DocumentedNode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_bt_py_interfaces__msg__DocumentedNode(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_bt_py_interfaces__msg__DocumentedNode;
    is_plain =
      (
...
static size_t _DocumentedNode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_bt_py_interfaces__msg__DocumentedNode(
...
static message_type_support_callbacks_t __callbacks_DocumentedNode = {
...
static rosidl_message_type_support_t _DocumentedNode__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DocumentedNode,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_bt_py_interfaces, msg, DocumentedNode)() {
  return &_DocumentedNode__type_support;
}
