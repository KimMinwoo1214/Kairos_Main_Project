...
bool ros_bt_py_interfaces__msg__package__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_bt_py_interfaces.msg._package.Package", full_classname_dest, 41) == 0);
  }
  ros_bt_py_interfaces__msg__Package * ros_message = _ros_message;
  {  // package
...
{
  /* NOTE(esteve): Call constructor of Package */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_bt_py_interfaces.msg._package");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Package");
