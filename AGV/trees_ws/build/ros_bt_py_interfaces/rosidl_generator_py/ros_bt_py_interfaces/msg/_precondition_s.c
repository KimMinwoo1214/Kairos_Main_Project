...
bool ros_bt_py_interfaces__msg__precondition__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_bt_py_interfaces.msg._precondition.Precondition", full_classname_dest, 51) == 0);
  }
  ros_bt_py_interfaces__msg__Precondition * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of Precondition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_bt_py_interfaces.msg._precondition");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Precondition");
