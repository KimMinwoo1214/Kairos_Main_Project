...
bool ros_bt_py_interfaces__msg__message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_bt_py_interfaces.msg._message.Message", full_classname_dest, 41) == 0);
  }
  ros_bt_py_interfaces__msg__Message * ros_message = _ros_message;
  {  // msg
...
PyObject * ros_bt_py_interfaces__msg__message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_bt_py_interfaces.msg._message");
