...
#include "ros_bt_py_interfaces/msg/detail/node__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_bt_py_interfaces::msg::Node;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_bt_py_interfaces::msg::Node *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_bt_py_interfaces::msg::Node *>(
    untyped_ros_message);
...
{
  return &ros_bt_py_interfaces::msg::typesupport_fastrtps_cpp::_Node__handle;
}
