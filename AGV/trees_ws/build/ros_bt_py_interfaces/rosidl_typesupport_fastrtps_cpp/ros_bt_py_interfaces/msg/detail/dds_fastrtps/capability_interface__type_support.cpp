...
#include "ros_bt_py_interfaces/msg/detail/capability_interface__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_bt_py_interfaces::msg::CapabilityInterface;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_bt_py_interfaces::msg::CapabilityInterface *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_bt_py_interfaces::msg::CapabilityInterface *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CapabilityInterface__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_bt_py_interfaces::msg::CapabilityInterface *>(
...
static size_t _CapabilityInterface__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_CapabilityInterface(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CapabilityInterface__callbacks = {
...
static rosidl_message_type_support_t _CapabilityInterface__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CapabilityInterface__callbacks,
...
{
  return &ros_bt_py_interfaces::msg::typesupport_fastrtps_cpp::_CapabilityInterface__handle;
}
