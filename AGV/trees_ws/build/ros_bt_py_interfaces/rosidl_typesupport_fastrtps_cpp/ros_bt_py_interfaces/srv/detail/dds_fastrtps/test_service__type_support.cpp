...
#include "ros_bt_py_interfaces/srv/detail/test_service__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_bt_py_interfaces::srv::TestService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_bt_py_interfaces::srv::TestService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_bt_py_interfaces::srv::TestService_Request *>(
    untyped_ros_message);
...
{
  return &ros_bt_py_interfaces::srv::typesupport_fastrtps_cpp::_TestService_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_bt_py_interfaces::srv::TestService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_bt_py_interfaces::srv::TestService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros_bt_py_interfaces::srv::TestService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros_bt_py_interfaces::srv::typesupport_fastrtps_cpp::_TestService_Response__handle;
}
...
{
  return &ros_bt_py_interfaces::srv::typesupport_fastrtps_cpp::_TestService__handle;
}
