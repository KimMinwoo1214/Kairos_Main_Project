...
#include "ros_bt_py_interfaces/srv/detail/wire_node_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  // Member: wirings
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.wirings[index], current_alignment);
    }
  }
  // Member: ignore_failure
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_bt_py_interfaces::srv::WireNodeData_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_bt_py_interfaces::srv::WireNodeData_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_bt_py_interfaces::srv::WireNodeData_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WireNodeData_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_bt_py_interfaces::srv::WireNodeData_Request *>(
...
static size_t _WireNodeData_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WireNodeData_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _WireNodeData_Request__callbacks = {
...
static rosidl_message_type_support_t _WireNodeData_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WireNodeData_Request__callbacks,
...
{
  return &ros_bt_py_interfaces::srv::typesupport_fastrtps_cpp::_WireNodeData_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_bt_py_interfaces::srv::WireNodeData_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_bt_py_interfaces::srv::WireNodeData_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros_bt_py_interfaces::srv::WireNodeData_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WireNodeData_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_bt_py_interfaces::srv::WireNodeData_Response *>(
...
static size_t _WireNodeData_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WireNodeData_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _WireNodeData_Response__callbacks = {
  "ros_bt_py_interfaces::srv",
...
static rosidl_message_type_support_t _WireNodeData_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WireNodeData_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &ros_bt_py_interfaces::srv::typesupport_fastrtps_cpp::_WireNodeData_Response__handle;
}
...
static service_type_support_callbacks_t _WireNodeData__callbacks = {
  "ros_bt_py_interfaces::srv",
  "WireNodeData",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_bt_py_interfaces, srv, WireNodeData_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_bt_py_interfaces, srv, WireNodeData_Response)(),
...
static rosidl_service_type_support_t _WireNodeData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WireNodeData__callbacks,
...
{
  return &ros_bt_py_interfaces::srv::typesupport_fastrtps_cpp::_WireNodeData__handle;
}
