...
bool ros_bt_py_interfaces__msg__capability_execution_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_bt_py_interfaces.msg._capability_execution_status.CapabilityExecutionStatus", full_classname_dest, 79) == 0);
  }
  ros_bt_py_interfaces__msg__CapabilityExecutionStatus * ros_message = _ros_message;
  {  // interface
...
{
  /* NOTE(esteve): Call constructor of CapabilityExecutionStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_bt_py_interfaces.msg._capability_execution_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CapabilityExecutionStatus");
