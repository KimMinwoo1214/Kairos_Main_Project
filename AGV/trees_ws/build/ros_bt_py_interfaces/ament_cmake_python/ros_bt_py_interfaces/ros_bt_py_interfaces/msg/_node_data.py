...
class NodeData(metaclass=Metaclass_NodeData):
    ...
    def __init__(self, **kwargs):
        ...
        self.serialized_value = kwargs.get('serialized_value', str())
        self.serialized_type = kwargs.get('serialized_type', str())
    ...
    def __eq__(self, other):
        ...
        if self.key != other.key:
            return False
        if self.serialized_value != other.serialized_value:
            return False
        if self.serialized_type != other.serialized_type:
            return False
        return True
    ...
    def serialized_value(self):
        """Message field 'serialized_value'."""
    ...
    def serialized_value(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'serialized_value' field must be of type 'str'"
        self._serialized_value = value

    @builtins.property
    def serialized_type(self):
        """Message field 'serialized_type'."""
        return self._serialized_type

    @serialized_type.setter
    def serialized_type(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'serialized_type' field must be of type 'str'"
        self._serialized_type = value
