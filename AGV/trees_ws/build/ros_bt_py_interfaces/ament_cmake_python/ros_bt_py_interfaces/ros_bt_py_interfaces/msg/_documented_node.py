...
class Metaclass_DocumentedNode(type):
    """Metaclass of message 'DocumentedNode'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__documented_node
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__documented_node
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__documented_node
            cls._TYPE_SUPPORT = module.type_support_msg__msg__documented_node
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__documented_node
    ...
    def UNINITIALIZED(self):
        ...
        return Metaclass_DocumentedNode.__constants['UNINITIALIZED']

    @property
    def IDLE(self):
        """Message constant 'IDLE'."""
        return Metaclass_DocumentedNode.__constants['IDLE']

    @property
    def RUNNING(self):
        """Message constant 'RUNNING'."""
        return Metaclass_DocumentedNode.__constants['RUNNING']

    @property
    def SUCCEEDED(self):
        """Message constant 'SUCCEEDED'."""
        return Metaclass_DocumentedNode.__constants['SUCCEEDED']

    @property
    def SUCCEED(self):
        """Message constant 'SUCCEED'."""
        return Metaclass_DocumentedNode.__constants['SUCCEED']

    @property
    def SUCCESS(self):
        """Message constant 'SUCCESS'."""
        return Metaclass_DocumentedNode.__constants['SUCCESS']

    @property
    def FAILED(self):
        """Message constant 'FAILED'."""
        return Metaclass_DocumentedNode.__constants['FAILED']

    @property
    def FAIL(self):
        """Message constant 'FAIL'."""
        return Metaclass_DocumentedNode.__constants['FAIL']

    @property
    def FAILURE(self):
        """Message constant 'FAILURE'."""
        return Metaclass_DocumentedNode.__constants['FAILURE']

    @property
    def BROKEN(self):
        """Message constant 'BROKEN'."""
        return Metaclass_DocumentedNode.__constants['BROKEN']

    @property
    def PAUSED(self):
        """Message constant 'PAUSED'."""
        return Metaclass_DocumentedNode.__constants['PAUSED']

    @property
    def SHUTDOWN(self):
        """Message constant 'SHUTDOWN'."""
        return Metaclass_DocumentedNode.__constants['SHUTDOWN']


class DocumentedNode(metaclass=Metaclass_DocumentedNode):
    """
    Message class 'DocumentedNode'.
    ...
    def doc(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'doc' field must be of type 'str'"
        self._doc = value
