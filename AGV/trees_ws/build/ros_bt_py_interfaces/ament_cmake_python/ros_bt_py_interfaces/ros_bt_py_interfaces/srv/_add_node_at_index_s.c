...
bool ros_bt_py_interfaces__srv__add_node_at_index__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_bt_py_interfaces.srv._add_node_at_index.AddNodeAtIndex_Request", full_classname_dest, 66) == 0);
  }
  ros_bt_py_interfaces__srv__AddNodeAtIndex_Request * ros_message = _ros_message;
  {  // parent_name
...
{
  /* NOTE(esteve): Call constructor of AddNodeAtIndex_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_bt_py_interfaces.srv._add_node_at_index");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AddNodeAtIndex_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool ros_bt_py_interfaces__srv__add_node_at_index__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_bt_py_interfaces.srv._add_node_at_index.AddNodeAtIndex_Response", full_classname_dest, 67) == 0);
  }
  ros_bt_py_interfaces__srv__AddNodeAtIndex_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of AddNodeAtIndex_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_bt_py_interfaces.srv._add_node_at_index");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AddNodeAtIndex_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
