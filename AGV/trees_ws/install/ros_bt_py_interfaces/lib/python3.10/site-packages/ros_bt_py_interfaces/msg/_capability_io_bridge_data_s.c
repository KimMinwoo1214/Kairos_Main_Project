...
bool ros_bt_py_interfaces__msg__capability_io_bridge_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_bt_py_interfaces.msg._capability_io_bridge_data.CapabilityIOBridgeData", full_classname_dest, 74) == 0);
  }
  ros_bt_py_interfaces__msg__CapabilityIOBridgeData * ros_message = _ros_message;
  {  // node_id
  ...
  {  // bridge_data
    PyObject * field = PyObject_GetAttrString(_pymsg, "bridge_data");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'bridge_data'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    ros_bt_py_interfaces__msg__NodeData * dest = ros_message->bridge_data.data;
...
{
  /* NOTE(esteve): Call constructor of CapabilityIOBridgeData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_bt_py_interfaces.msg._capability_io_bridge_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CapabilityIOBridgeData");
  ...
  {  // bridge_data
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->bridge_data.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "bridge_data", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
