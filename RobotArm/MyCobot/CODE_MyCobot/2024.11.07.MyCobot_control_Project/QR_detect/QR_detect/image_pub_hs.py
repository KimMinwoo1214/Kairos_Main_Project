...
class MyCobotController(QWidget):
    def __init__(self):
        ...
        self.qr_recognized = False  # QR 코드 인식 여부
        self.last_recognition_time = time.time()  # 마지막 QR 코드 인식 시간
        self.timeout = 10  # QR 코드 인식 타임아웃 설정
        self.initUI()
