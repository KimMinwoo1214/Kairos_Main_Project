...
label1.pack(pady=10)
slider1 = ttk.Scale(root, from_=0, to_=4095, orient="horizontal")
...
label2.pack(pady=10)
slider2 = ttk.Scale(root, from_=0, to_=4095, orient="horizontal")
...
label3.pack(pady=10)
slider3 = ttk.Scale(root, from_=0, to_=4095, orient="horizontal")
...
# Stop 버튼
stop_button = ttk.Button(root, text="Stop", command=stop_all_servos)
