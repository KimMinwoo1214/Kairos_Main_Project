...
print(os.listdir('/home/pi/Revise_Code/2024.11.27_camera_calibration'))  # List all files in the current directory
...
images = glob.glob('/home/pi/Revise_Code/2024.11.27_camera_calibration/*.jpg')  # Adjust this path if needed for your image files
